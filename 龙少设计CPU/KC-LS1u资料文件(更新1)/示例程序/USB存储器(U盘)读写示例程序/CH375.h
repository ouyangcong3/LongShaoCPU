...
unsigned char CH375_RD_LBA(unsigned char device,unsigned int SQH,unsigned char LBAX,unsigned char *buf) //USB存储器设备读扇区, device选择设备,SQH为起始扇区号,LBAX为读扇区的个数,buf为缓冲区首地址,如果操作成功返回值不为0
{
...
unsigned char CH375_WR_LBA(unsigned char device,unsigned int SQH,unsigned char LBAX,unsigned char *buf) //USB存储器设备写扇区, device选择设备,SQH为起始扇区号,LBAX为写扇区的个数,buf为缓冲区首地址,如果操作成功返回值不为0
{
